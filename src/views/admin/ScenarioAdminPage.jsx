      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-500 rounded-none transition-colors"
            >
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <button
              onClick={handleCreate}
              className="mt-4 px-4 py-2 bg-purple-600 hover:bg-purple-500 rounded-none transition-colors"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {scenarios.map(scenario => (
              <div 
                key={scenario.id} 
                className={`bg-gray-800/50 border rounded-none overflow-hidden ${
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-700 hover:bg-gray-600 rounded-none transition-colors text-sm"
                    >
