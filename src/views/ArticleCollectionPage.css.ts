...
export const cardCategory = style({ fontFamily: vars.font.mono, fontSize: '10px', letterSpacing: '0.08em', textTransform: 'uppercase', color: vars.color.accent, marginBottom: vars.space.xs });
...
export const cardMeta = style({ fontFamily: vars.font.mono, fontSize: '11px', color: vars.color.textFaint });
